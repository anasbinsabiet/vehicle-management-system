    ...
    <div class="col-sm-9 mx-auto">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form method="POST" id="type_forms" class="type_forms">
...
<?php if(isset($_GET['id'])){ ?>
  <script type="text/javascript">
    ...
    if (type_id != Number.isNaN(NaN) || type_id != '') {
      ...
      $.ajax({
        url: 'action.php',
        method: "POST",
        data: {type_id: type_id, btn_action: btn_action},
        dataType: "json",
...
$(document).on('submit', '#type_forms', function (event) {
