  ...
  <div class="container">
    ...
    <div class="col-sm-9 mx-auto">
      ...
      <div class="card">
        ...
        <form method="POST" id="group_forms" class="group_forms">
...
<?php if(isset($_GET['id'])){ ?>
  <script type="text/javascript">
    ...
    if (group_id != Number.isNaN(NaN) || group_id != '') {
      ...
      $.ajax({
        url: 'action.php',
        method: "POST",
        data: {group_id: group_id, btn_action: btn_action},
        dataType: "json",
...
$(document).on('submit', '#group_forms', function (event) {
