...
<div class="row mb-2">
  <div class="col-sm-6">
    <h1 class="m-0 text-dark">Users Setup</h1>
  </div><!-- /.col -->
  <div class="col-sm-6">
    <ol class="breadcrumb float-sm-right">
      <li class="breadcrumb-item active"><a
          href="<?php echo $_SESSION['base_url'] . 'dashboard/index'; ?>">Dashboard</a></li>
      <li class="breadcrumb-item active">Users Country</li>
    </ol>
  </div><!-- /.col -->
</div><!-- /.row -->
</div><!-- /.container-fluid -->
    ...
    <div class="card">
      ...
      <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
          <?php
          $query = $connect->prepare("SELECT * FROM `vendors_country`");
          $query->execute();
          ...
          foreach ($result as $row) {
            ...
            <tr>
              ...
              <td>
                <a
                  href="add.php?id=<?php echo $row['country_id']; ?>">
