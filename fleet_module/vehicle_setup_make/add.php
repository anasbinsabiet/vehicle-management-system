  ...
  <div class="container">
    ...
    <div class="col-sm-9 mx-auto">
      ...
      <div class="card">
        ...
        <form method="POST" id="make_forms" class="make_forms">

          <div class="form-group">
            <input type="text" class="form-control" name="make" id="make" placeholder="Make" required>
            <input type="hidden" class="form-control" name="make_id" id="make_id">
          </div>
...
<?php if(isset($_GET['id'])){ ?>
  <script type="text/javascript">
    ...
    if (make_id != Number.isNaN(NaN) || make_id != '') {
      ...
      $.ajax({
        url: 'action.php',
        method: "POST",
        data: {make_id: make_id, btn_action: btn_action},
        dataType: "json",
...
$(document).on('submit', '#make_forms', function (event) {
