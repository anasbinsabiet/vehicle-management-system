    ...
    <div class="card">
      ...
      <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
          <?php
          $query = $connect->prepare("SELECT * FROM `vehicle_details_model`");
          $query->execute();
          ...
          foreach ($result as $row) {
            ...
            <tr>
              ...
              <td>
                <a
                  href="add.php?id=<?php echo $row['model_id']; ?>">
                  <button class="badge badge-info btn-xs">Edit</button>
                </a>

                <button type="button" name="delete" id="<?php echo $row["model_id"] ?>"
    ...
    $(document).on('click', '.delete', function () {
      ...
      if (confirm("Are you sure you want to change status?")) {
        $.ajax({
          url: "action.php",
          method: "POST",
          data: {model_id: model_id, status: status, btn_action: btn_action},
